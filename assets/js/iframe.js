...
window.GoogleMaps = _googleMaps2.default;

(0, _jquery2.default)(document).ready(function () {

    (0, _jquery2.default)(document).on('click', 'a[data-type="dropdown"], a[data-type="secondary"]', function () {
        var current = this;
        var type = (0, _jquery2.default)(this).data('type');
        (0, _jquery2.default)(this).closest('.bloks__component__box').find('.bloks__dropdown').find('a[data-type="' + type + '"]').each(function (i, el) {
            if (el !== current) {
                (0, _jquery2.default)(el).removeClass('active');
                (0, _jquery2.default)(el).next().removeClass('active');
            }
        });

        if ((0, _jquery2.default)(this).hasClass('active')) {
            (0, _jquery2.default)(this).removeClass('active');
            (0, _jquery2.default)(this).next().removeClass('active');

            /**
             * Enable tooltip feature when element removed class active
             */
            if ((0, _jquery2.default)(this).hasClass('bloks-tooltip')) {
                (0, _jquery2.default)(this).tooltipster('enable');
            }
        } else {
            (0, _jquery2.default)(this).addClass('active');
            var next = (0, _jquery2.default)(this).next();
            var left = 0 - (0, _jquery2.default)(next).width() / 2 + (0, _jquery2.default)(this).parent().outerWidth() / 2;
            (0, _jquery2.default)(next).css({
                left: left + 'px'
            }).addClass('active');
            (0, _jquery2.default)(this).closest('.bloks__component__box').find('.testimonial-toolbar').removeClass('active');

            /**
             * Disable tooltip feature when element has class active
             */
            if ((0, _jquery2.default)(this).hasClass('bloks-tooltip')) {
                (0, _jquery2.default)(this).tooltipster('disable');
            }
        }
    });
});
